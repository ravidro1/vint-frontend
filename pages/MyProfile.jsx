...
const MyProfile = () => {
  ...
  const renderFollowers = ({item, index}) => {
    ...
    return (
      <View
        key={index}
        className="h-20 w-full flex-row items-center justify-between pl-2 pr-4 border border-b-white border-t-white"
      >
  ...
  return (
    <View style={{height: Dimensions.get("window").height - 100}}>
      ...
      <View style={styles.topBar}>
        ...
        <Pressable
          className="h-full w-20 justify-center items-end"
      ...
      <View style={styles.profileDetails}>
        <View style={styles.profileDetailsTop}>
          <View style={styles.numbers}>
            ...
            <View style={styles.numbersText}>
              ...
              <Text style={styles.profileDetailsBottomText}>
                {posts.length}
              </Text>
            </View>
            <TouchableOpacity
              style={styles.numbersText}
              onPressOut={() => toggleFollowersModal()}
            >
            ...
            <TouchableOpacity
              style={styles.numbersText}
              onPressOut={() => toggleFollowingModal()}
            >
        ...
        <View style={styles.profileDetailsMid}></View>
        <View style={styles.profileDetailsBottom}>
          <Pressable
            style={styles.pressableArea}
            onPress={() => setProfileType("For Sale")}
          >
          ...
          <Pressable
            style={styles.pressableArea}
            onPress={() => setProfileType("History")}
          >
      ...
      >
        <View className="h-screen w-screen flex-col bg-slate-50 rounded-3xl">
          <View
            ...
            className="w-full h-16 justify-end bg-slate-50 rounded-t-3xl"
          >
            <Pressable
              className="w-max h-16 mt-3 justify-center items-end pr-8 border-b-[1] border-b bg-slate-50"
          ...
          <View
            ...
            className="w-full bg-slate-400 justify-end rounded-b-3xl"
          >
            <View style={styles.settingsZone}>
              {settingVisible && (
                <View className="h-3/5 w-full items-center pl-4 pr-8 bg-white border-t-[1] border-t">
                  <Pressable
                    className="flex-1 w-full flex-row justify-between items-center"
                    onPress={() => openSpecificSettings("personal info")}
                  >
                  ...
                  <Pressable
                    className="flex-1 w-full flex-row justify-between items-center"
                    onPress={() => openSpecificSettings("email")}
                  >
                  ...
                  <Pressable
                    className="flex-1 w-full flex-row justify-between items-center"
                    onPress={() => openSpecificSettings("password")}
                  >
                  ...
                  <Pressable
                    className="flex-1 w-full flex-row justify-between items-center"
                    onPress={() => openSpecificSettings("delete account")}
                  >
              ...
              {settingsType === "personal info" && <PersonalInfo />}
              {settingsType === "email" && <EmailSettings />}
              {settingsType === "password" && <PasswordSettings />}
              {settingsType === "delete account" && <DeleteAccount />}
            </View>
            <View style={styles.buttonsZone}>
              ...
              <View className="w-full h-16 bg-white">
                <Pressable
                  className="h-full flex-row justify-between items-center pl-4 pr-8"
              ...
              <View className="w-full h-16 bg-white mb-32">
                <Pressable
                  className="h-full flex-row justify-start items-center pl-4"
                  onPressOut={() => showAlert()}
                >
                  <Ionicons
